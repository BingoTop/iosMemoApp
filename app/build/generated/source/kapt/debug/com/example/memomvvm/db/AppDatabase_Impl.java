  ...
  protected SupportSQLiteOpenHelper createOpenHelper(DatabaseConfiguration configuration) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(configuration, new RoomOpenHelper.Delegate(1) {
      ...
      public void createAllTables(SupportSQLiteDatabase _db) {
        _db.execSQL("CREATE TABLE IF NOT EXISTS `memo_table` (`id` INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, `desc` TEXT, `createdAt` INTEGER NOT NULL)");
        _db.execSQL("CREATE TABLE IF NOT EXISTS room_master_table (id INTEGER PRIMARY KEY,identity_hash TEXT)");
        _db.execSQL("INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, '160dfa9f9245ca9de52d3ac0d9f31f9c')");
      }
      ...
      protected RoomOpenHelper.ValidationResult onValidateSchema(SupportSQLiteDatabase _db) {
        ...
        _columnsMemoTable.put("desc", new TableInfo.Column("desc", "TEXT", false, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsMemoTable.put("createdAt", new TableInfo.Column("createdAt", "INTEGER", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        ...
        if (! _infoMemoTable.equals(_existingMemoTable)) {
          return new RoomOpenHelper.ValidationResult(false, "memo_table(com.example.memomvvm.db.MemoEntity).\n"
                  + " Expected:\n" + _infoMemoTable + "\n"
                  + " Found:\n" + _existingMemoTable);
        }
        return new RoomOpenHelper.ValidationResult(true, null);
      }
    }, "160dfa9f9245ca9de52d3ac0d9f31f9c", "8e3466f9b53113f82b5d8832574a3db0");
